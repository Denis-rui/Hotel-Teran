...
$habitacionContr = new HabitacionController();
$habitaciones = $habitacionContr->habitacionesDispnibles();
          ...
          <select
            ...
            <?php foreach ($habitaciones as $habitacion): ?>
              <option value="<?= $habitacion['id'] ?>">
                <?= "Habitación " . $habitacion['numero_habitacion'] . " - " . $habitacion['tipo_nombre'] . " - S/." . $habitacion['precio'] ?>
              </option>
            <?php endforeach; ?>
